...
export const projects: Project[] = [
  {
    ...
    image: 'https://i.ibb.co/KpTYHvsH/Screenshot-2026-07-08-184612.png',
    techStack: ['React', 'Spring Boot', 'PostgreSQL', 'JWT', 'WebSocket', 'Spring Security'],
    githubUrl: 'https://github.com/devanshshrivastava16/trustspace-backend',
    liveUrl: 'https://trustspace.vercel.app/',
    featured: true,
    category: 'Full-Stack',
  },
  {
    ...
    image: 'https://i.ibb.co/chRgSbMt/Screenshot-2026-07-08-184856.png',
    techStack: ['Spring Boot', 'React.js', 'Node.js', 'PostgreSQL', 'pgvector', 'Redis'],
    githubUrl: 'https://github.com/devanshshrivastava16/vikas-backend',
    liveUrl: 'https://vikast.naitiktiwari.in',
    featured: true,
    category: 'Backend / AI',
  },
  {
    ...
    githubUrl: 'https://github.com/devanshshrivastava16/MicroService-With-User-And-Contact-Services',
    liveUrl: '#',
    featured: true,
    category: 'Backend',
  },
  {
    ...
    image: 'https://i.ibb.co/k2rWghdp/Screenshot-2026-07-08-184057.png',
    techStack: ['React', 'TypeScript', 'Vite', 'Tailwind CSS', 'Framer Motion'],
    githubUrl: 'https://github.com/devanshshrivastava16/devansh_portfolio',
    liveUrl: 'https://devansh-portfolio-beta.vercel.app/',
    featured: true,
    category: 'Frontend',
  },
];